...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-wlf {C:/Users/Gustavo\ Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/05-Logica-Sequencial/vunit_out/test_output/c5c66660a959522836aa1c4c7aae83ec20d9bfef/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_register16/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/05-Logica-Sequencial/vunit_out/test_output/c5c66660a959522836aa1c4c7aae83ec20d9bfef/,tb path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/05-Logica-Sequencial/testBench/"} lib.tb_register16(tb)   -L vunit_lib -L lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -wlf {C:/Users/Gustavo\ Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/05-Logica-Sequencial/vunit_out/test_output/c5c66660a959522836aa1c4c7aae83ec20d9bfef/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_register16/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/05-Logica-Sequencial/vunit_out/test_output/c5c66660a959522836aa1c4c7aae83ec20d9bfef/,tb path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/05-Logica-Sequencial/testBench/"} lib.tb_register16(tb)   -L vunit_lib -L lib' failed
...
proc vunit_compile {} {
    set cmd_show {C:\Users\Gustavo Gobetti\Anaconda\python.exe -u teste05.py --compile}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {C:\Users\Gustavo Gobetti\Anaconda\python.exe} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['C:\\Users\\Gustavo Gobetti\\Anaconda\\python.exe', '-u', 'teste05.py', '--compile'], cwd='C:\\Users\\Gustavo Gobetti\\Documents\\Insper\\4-Semestre-2017\\Elementos-de-Sistema-2\\Z0\\05-Logica-Sequencial', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
