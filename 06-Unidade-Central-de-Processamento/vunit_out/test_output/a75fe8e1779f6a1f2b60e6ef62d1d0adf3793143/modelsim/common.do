...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-wlf {C:/Users/Gustavo\ Gobetti/Documents/Insper/4-Semestre-2017/Z0/06-Unidade-Central-de-Processamento/vunit_out/test_output/a75fe8e1779f6a1f2b60e6ef62d1d0adf3793143/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_controlunit/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Z0/06-Unidade-Central-de-Processamento/vunit_out/test_output/a75fe8e1779f6a1f2b60e6ef62d1d0adf3793143/,tb path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Z0/06-Unidade-Central-de-Processamento/testBench/"} lib.tb_controlunit(tb)   -L vunit_lib -L lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -wlf {C:/Users/Gustavo\ Gobetti/Documents/Insper/4-Semestre-2017/Z0/06-Unidade-Central-de-Processamento/vunit_out/test_output/a75fe8e1779f6a1f2b60e6ef62d1d0adf3793143/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_controlunit/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Z0/06-Unidade-Central-de-Processamento/vunit_out/test_output/a75fe8e1779f6a1f2b60e6ef62d1d0adf3793143/,tb path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Z0/06-Unidade-Central-de-Processamento/testBench/"} lib.tb_controlunit(tb)   -L vunit_lib -L lib' failed
...
proc vunit_compile {} {
    set cmd_show {C:\Users\Gustavo Gobetti\Anaconda\python.exe -u C:\Users\Gustavo Gobetti\Documents\Insper\4-Semestre-2017\Z0\06-Unidade-Central-de-Processamento\teste06.py --compile}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {C:\Users\Gustavo Gobetti\Anaconda\python.exe} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['C:\\Users\\Gustavo Gobetti\\Anaconda\\python.exe', '-u', 'C:\\Users\\Gustavo Gobetti\\Documents\\Insper\\4-Semestre-2017\\Z0\\06-Unidade-Central-de-Processamento\\teste06.py', '--compile'], cwd='C:\\Users\\Gustavo Gobetti\\Documents\\Insper\\4-Semestre-2017\\Z0\\06-Unidade-Central-de-Processamento', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
