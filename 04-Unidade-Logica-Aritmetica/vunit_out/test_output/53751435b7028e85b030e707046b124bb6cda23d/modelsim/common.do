...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-wlf {C:/Users/Gustavo\ Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/04-Unidade-Logica-Aritmetica/vunit_out/test_output/53751435b7028e85b030e707046b124bb6cda23d/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_comparador16/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/04-Unidade-Logica-Aritmetica/vunit_out/test_output/53751435b7028e85b030e707046b124bb6cda23d/,tb path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/04-Unidade-Logica-Aritmetica/testBench/"} lib.tb_comparador16(tb)   -L vunit_lib -L lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -wlf {C:/Users/Gustavo\ Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/04-Unidade-Logica-Aritmetica/vunit_out/test_output/53751435b7028e85b030e707046b124bb6cda23d/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_comparador16/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/04-Unidade-Logica-Aritmetica/vunit_out/test_output/53751435b7028e85b030e707046b124bb6cda23d/,tb path : C::/Users/Gustavo Gobetti/Documents/Insper/4-Semestre-2017/Elementos-de-Sistema-2/Z0/04-Unidade-Logica-Aritmetica/testBench/"} lib.tb_comparador16(tb)   -L vunit_lib -L lib' failed
...
proc vunit_compile {} {
    set cmd_show {C:\Users\Gustavo Gobetti\Anaconda\python.exe -u teste04.py --compile}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {C:\Users\Gustavo Gobetti\Anaconda\python.exe} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['C:\\Users\\Gustavo Gobetti\\Anaconda\\python.exe', '-u', 'teste04.py', '--compile'], cwd='C:\\Users\\Gustavo Gobetti\\Documents\\Insper\\4-Semestre-2017\\Elementos-de-Sistema-2\\Z0\\04-Unidade-Logica-Aritmetica', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
